// File: electron/handlers/getPendingStockTransfers.js
import db from '../electron/db/connection.js';
import axios from 'axios';
import sessions from '../electron/db/queries/sessions.js';

export default async function getPendingStockTransfers() {
  try {
    ...
    const response = await axios.get(`${session.tenant_url}/api/stock-transfers/pending`, {
      headers: {
