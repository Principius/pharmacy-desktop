        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <button type="button"
                        class="flex items-center px-6 py-2 text-xl font-semibold text-white transition duration-300 rounded-lg shadow-lg bg-gradient-to-r from-orange-500 to-yellow-400 hover:from-orange-600 hover:to-yellow-500 focus:outline-none focus:ring-4 focus:ring-orange-400">
                ...
                <div class="flex items-center">
                    <div class="flex items-center space-x-6 ms-3">
                        <!--   <CountedMessages :unreadMessages="props.unreadMessages" /> -->
                        <div class="relative">
                            <button type="button" @click="toggleUserMenu"
                                class="relative flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-200 dark:text-white"
                                aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                <span class="sr-only">Open user menu</span>
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="none"
                                    viewBox="0 0 24 24">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <Link @click="$router.push('/inventory')"
                            class="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <Link @click="$router.push('/products')"
                            class="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <li >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Low Stock</span>
                        </Link>
                    </li>

                    <li>
                        <Link @click="$router.push('/expenses')"
                            class="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Profit & Loss</span>
                        </Link>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Profit</span>
                        </Link>
                    </li>
                    ...
                    <li >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Stock Transfer</span>
                        </Link>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">High/Low Demand</span>
                        </Link>
                    </li>
                    <li>
                        <Link
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Damaged Goods</span>
                        </Link>
                    </li>
                    <li>
                        <Link
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Debtors</span>
                        </Link>
                    </li>
                    <li>
                        <Link
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Special Summary</span>
                        </Link>
                    </li>
                    <li>
                        <button type="button" @click="toggleReportsDropdown"
                            ...
                            <svg class="w-3 h-3 transform" :class="{ 'rotate-180': isReportsDropdownOpen }"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
                        <ul id="dropdown-example" :class="{ hidden: !isReportsDropdownOpen }" class="py-2 space-y-2">
                            <li>
                                <Link
                    ...
                    <li>
                        <button as="button" @click="$router.push('/login')"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
...
import CountedMessages from './CountedMessages.vue';
...
const isSidebarVisibleOnSmallScreen = ref(false);
...
const toggleSidebar = () => {
    isSidebarVisibleOnSmallScreen.value = !isSidebarVisibleOnSmallScreen.value;
};
...
<style scoped>
footer {
    background-image: linear-gradient(to right, #ebf8ff, #d1eaff);
